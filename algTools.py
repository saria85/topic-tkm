...
def words_to_index(docs): #use 1 for true
    ...
    return mdocs, id2word, word2id,sorted_counts
...
def process_corpus(corpus, min_doc_length=10):
    ...
    transformed_corpus, id2word, word2id,sorted_word_count = words_to_index(tokenized_corpus)
    ...
    transformed_corpus, id2word, word2id,sorted_word_count = words_to_index(filtered_docs)
    return transformed_corpus, id2word,word2id,sorted_word_count
...
def print_topics(p_w_t, id2word, max_topics=50, max_words=15):
    ...
    for topic_i in range(min(n_topics, max_topics)):
        ...
        # print(word_topic_probabilities)
